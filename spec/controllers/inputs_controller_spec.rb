...
describe InputsController do
  ...
  # InputsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested input as @input" do
      input = Input.create! valid_attributes
      get :show, {:id => input.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested input as @input" do
      input = Input.create! valid_attributes
      get :edit, {:id => input.to_param}, valid_session
      assigns(:input).should eq(input)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created input" do
        post :create, {:input => valid_attributes}, valid_session
        response.should redirect_to(Input.last)
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested input" do
        input = Input.create! valid_attributes
        # Assuming there are no other inputs in the database, this
        # specifies that the Input created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Input.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => input.to_param, :input => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested input as @input" do
        input = Input.create! valid_attributes
        put :update, {:id => input.to_param, :input => valid_attributes}, valid_session
        assigns(:input).should eq(input)
      end
      ...
      it "redirects to the input" do
        input = Input.create! valid_attributes
        put :update, {:id => input.to_param, :input => valid_attributes}, valid_session
        response.should redirect_to(input)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the input as @input" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Input.any_instance.stub(:save).and_return(false)
        put :update, {:id => input.to_param, :input => {}}, valid_session
        assigns(:input).should eq(input)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested input" do
      input = Input.create! valid_attributes
      expect {
        delete :destroy, {:id => input.to_param}, valid_session
      }.to change(Input, :count).by(-1)
    end
